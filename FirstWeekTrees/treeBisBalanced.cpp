...
int main() {
    ...
    // Add nodes
    tree->addNode(8,"AAATA8");

    tree->addNode(4,"AAATA4");
    tree->addNode(12,"AAATA12");

    tree->addNode(2,"AAATA2");
    tree->addNode(6,"AAATA6");
    tree->addNode(10,"AAATA10");
    tree->addNode(14,"AAATA14");

    tree->addNode(1,"AAATA1");
    tree->addNode(3,"AAATA3");
    tree->addNode(5,"AAATA5");
    tree->addNode(7,"AAATA7");
    tree->addNode(9,"AAATA9");
    tree->addNode(11,"AAATA11");
    tree->addNode(13,"AAATA13");
    tree->addNode(15,"AAATA15");
